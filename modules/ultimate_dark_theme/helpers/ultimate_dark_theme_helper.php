<?php
/*
Module Name: Ultimate Dark Theme for Perfex
Description: Ultimate Description: Ultimate Dark Theme for Perfex
 Theme for Perfex
Version: 2.2.0
...
function admin_theme_staff_login(){
    ...
    echo '<link href="' . base_url('modules/ultimate_dark_theme/assets/css/staff_login_styles.css') . '"  rel="stylesheet" type="text/css" >';
}
/**
