                              ...
                              <table class="table border table-striped table-margintop">
                                  <tbody>
                                     ...
                                     <tr class="project-overview">
                                        ...
                                        <td><?php echo warehouse_get_group_name(html_entity_decode($commodity_item->group_id)) != null ? warehouse_get_group_name(html_entity_decode($commodity_item->group_id))->name : '' ; ?></td>
                                     </tr>
                                     <tr class="project-overview">
