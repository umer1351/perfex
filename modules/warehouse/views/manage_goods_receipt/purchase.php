                  ...
                  <div class="col-md-12">
                     <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-6">
                          <?php $goods_receipt_code = (isset($goods_code) ? $goods_code : '');?>
                        ...
                        <div class="col-md-6">
                          <?php 
                          echo render_input('supplier_name','supplier_name') ?>
                        </div>
                      ...
                      <div class=" col-md-6">
                       ...
                       <div class="col-md-6 <?php if($pr_orders_status == false){ echo 'hide';} ;?>" >
                        ...
                        <div class="col-md-6">
                          <?php echo render_select('warehouse_id',$warehouses,array('warehouse_id',array('warehouse_code','warehouse_name')),'warehouse_in'); ?>
                        </div>
