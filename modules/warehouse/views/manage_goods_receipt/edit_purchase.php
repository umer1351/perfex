  ...
  <div id="wrapper">
   <div class="content">
                ...
                <div class="panel-body">
                  ...
                  <div class="col-md-12 pull-right">
                    ...
                    <div class="row">
                      ...
                      <p><span class="bold"><?php echo _l('voucher_number'); ?>: </span><?php echo html_entity_decode($goods_receipt->goods_receipt_code) ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        <td class="bold" width="21%"><?php echo _l('deliver_name'); ?></td>
                        <td><?php echo html_entity_decode($goods_receipt->deliver_name); ?></td>
                      </tr>
                      <tr>
                        <td class="bold"><?php echo _l('no'); ?></td>
                        <td><?php echo html_entity_decode($goods_receipt->goods_receipt_code); ?></td>
                      </tr>
                      <tr>
                        <td class="bold"><?php echo _l('input_in_stock'); ?></td>
                        <td>...</td>
                      </tr>
                     
                      <tr>
                        <td class="bold"><?php echo _l('acc_attach'); ?></td>
                        <td><?php if(isset($payslip)){
                        $data = '<div class="row">';
                        foreach($payslip->files as $attachment) {
                          $href_url = site_url('modules/accounting/uploads/payslip/'.$attachment['rel_id'].'/'.$attachment['file_name']).'" download';
                          if(!empty($attachment['external'])){
                            $href_url = $attachment['external_link'];
                          }
                          $data .= '<div class="display-block payslip-file-wrapper">';
                          ...
                          if($attachment['staffid'] == get_staff_user_id() || is_admin()){
                           $data .= '<a href="#" class="text-danger" onclick="delete_payslip_file(this,'.$attachment['id'].'); return false;"><i class="fa fa fa-times"></i></a>';
                         }
                         $data .= '</div>';
                         $data .= '</div>';
                        }
                  ...
                  <table class="table table-bordered">
                    <tbody>
                     <tr>
                       ...
                       <th colspan="1"><?php echo _l('unit_price') ?></th>
                       <th colspan="1"><?php echo _l('total_money') ?></th>
                      </tr>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        <td class="bold" width="21%"><?php echo _l('amount_of'); ?> :</td>
                          <td><?php echo app_format_money((float)$goods_receipt->total_money,''); ?>(VND)</td>
                      </tr>
                      <tr>
                        
                      </tr>
                      <tr>
                        <td class="bold"><?php echo _l('origin_voucher_following'); ?> :</td>
                          <td>...</td>
                      </tr>
                    </tbody>
                  </table>
    ...
    <?php } ?>
                  ...
                  <?php 
                  if($goods_receipt->approval != 1 && ($check_approve_status == false || $check_approve_status == 'reject'))
