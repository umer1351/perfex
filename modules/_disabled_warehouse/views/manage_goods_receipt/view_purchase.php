         ...
         <div class="row">
            ...
            <div class="col-md-8">
               <div class="pull-right _buttons">
                  ...
                  <a href="<?php echo admin_url('warehouse/edit_purchase/'.$goods_receipt->id); ?>" class="btn btn-default btn-with-tooltip" data-toggle="tooltip" title="<?php echo _l('edit'); ?>" data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
          ...
          <div class="col-md-12 panel-padding">
            <table class="table border table-striped table-margintop" >
              <tbody>
                ...
                <tr class="project-overview">
                    <td class="bold"><?php echo _l('license_number'); ?></td>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-7 col-md-offset-5">
                        <table class="table text-right">
                           <tr>
                            <td class="bold text-left" width="50%"><?php echo _l('amount_of') ?> :</td>

                              <td><?php echo app_format_money((float)$goods_receipt->total_money,'') ?>(VND)</td>
                          </tr>
                          <tr>
                              <td class="bold text-left" width="50%"><?php echo _l('amount_of_in_word') ?> :</td>
