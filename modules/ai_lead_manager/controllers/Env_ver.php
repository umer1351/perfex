...
class Env_ver extends AdminController
{
    ...
    {
        $this->load->library('ai_lead_manager/Envatoapi');
        ...
        $envato_res = $this->envatoapi->getPurchaseData($this->input->post('purchase_key'));
        ...
        try {
            ...
            $request = api_Requests::post(AI_LEAD_MANAGER_REG_PROD_POINT, $headers, $data);
