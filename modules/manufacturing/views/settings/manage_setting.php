...
<?php if(!(strpos($viewuri,ADMIN_URL . '/manufacturing/setting?group=working_hour') === false)){
	require 'modules/manufacturing/assets/js/settings/working_hour_js.php';
}elseif(!(strpos($viewuri,ADMIN_URL . '/manufacturing/setting?group=unit_of_measure_categories') === false)){
	require 'modules/manufacturing/assets/js/settings/add_edit_categories_js.php';
}elseif(!(strpos($viewuri,ADMIN_URL . '/manufacturing/setting?group=unit_of_measure') === false)){
