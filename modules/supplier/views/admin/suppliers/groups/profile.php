         ...
         <div role="tabpanel" class="tab-pane<?php if (!$this->input->get('tab')) {
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php echo render_input('company', 'supplier', $value, 'text', $attrs); ?>
                  ...
                  ?>
                  <?php if (!isset($client)) { ?>
                     <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="<?php echo _l('supplier_currency_change_notice'); ?>"></i>
                  <?php }
                  ...
                  <tbody>
                     <?php foreach ($customer_admins as $c_admin) { ?>
                        <tr>
                           ...
                           <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
                              <td>
                                 <a href="<?php echo admin_url('supplier/delete_customer_admin/' . $client->userid . '/' . $c_admin['staff_id']); ?>" class="btn btn-danger _delete btn-icon"><i class="fa fa-remove"></i></a>
                              </td>
                           <?php } ?>
                        </tr>
                     <?php } ?>
               ...
               <div class="col-md-12">
                  <div class="row">
                     <div class="col-md-6 dsdas">
                        <h4 class="no-mtop"><?php echo _l('billing_address'); ?> <a href="#" class="pull-right billing-same-as-customer"><small class="font-medium-xs"><?php echo _l('supplier_billing_same_as_profile'); ?></small></a></h4>
                        <hr />
                     ...
                     <div class="col-md-6">
                        <h4 class="no-mtop">
                           <i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('supplier_shipping_address_notice'); ?>"></i>
...
<?php if (isset($client)) { ?>
   <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
      <div class="modal fade" id="customer_admins_assign" tabindex="-1" role="dialog">
         <div class="modal-dialog">
            <?php echo form_open(admin_url('supplier/assign_admins/' . $client->userid)); ?>
   ...
   <?php } ?>
<?php } ?>
<?php $this->load->view('admin/suppliers/client_group'); ?>