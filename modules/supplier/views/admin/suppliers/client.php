         ...
         <div class="col-md-12">
            <?php if(isset($client) && $client->registration_confirmed == 0 && is_admin()){ ?>
               <div class="alert alert-warning">
                  ...
                  <br />
                  <a href="<?php echo admin_url('supplier/confirm_registration/'.$client->userid); ?>"><?php echo _l('confirm_registration'); ?></a>
               </div>
            <?php } else if(isset($client) && $client->active == 0 && $client->registration_confirmed == 1){ ?>
            <div class="alert alert-warning">
               <?php echo _l('supplier_inactive_message'); ?>
               <br />
               <a href="<?php echo admin_url('supplier/mark_as_active/'.$client->userid); ?>"><?php echo _l('mark_as_active'); ?></a>
            </div>
            <?php } ?>
            <?php if(isset($client) && (!has_permission('customers','','view') && is_customer_admin($client->userid))){?>
            <div class="alert alert-info">
               <?php echo _l('supplier_admin_login_as_client_message',get_staff_full_name(get_staff_user_id())); ?>
            </div>
            <?php } ?>
         </div>
                  ...
                  <h4 class="bold">
                     ...
                     <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                           <?php if(is_admin()){ ?>
                           <li>
                              <a href="<?php echo admin_url('supplier/login_as_client/'.$client->userid); ?>" target="_blank">
                           ...
                           <li>
                              <a href="<?php echo admin_url('supplier/delete/'.$client->userid); ?>" class="text-danger delete-text _delete"><i class="fa fa-remove"></i> <?php echo _l('delete'); ?>
                              </a>
                           </li>
                           <?php } ?>
                        </ul>
                     ...
                     <?php if(isset($client) && $client->leadid != NULL){ ?>
                        <br />
                        <small>
                           <b><?php echo _l('supplier_from_lead',_l('lead')); ?></b>
               ...
               <div class="panel-body">
                  ...
                  <div>
                     <div class="tab-content">
                           ...
                           <?php  $this->load->view((isset($tab) ? $tab['view'] : 'admin/suppliers/groups/profile')); ?>
                     </div>
                  </div>
               </div>
            </div>
...
<script>
   ...
   if($('.customer-profile-tabs li:first a').attr('href') == '#contact_info'){
        $('.customer-profile-tabs li:first a').text('Supplier Details');
