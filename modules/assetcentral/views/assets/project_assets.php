...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons">
                    <a href="<?php echo admin_url('projects/view/' . $project_id); ?>" class="btn btn-success">
                        <i class="fa-solid fa-backward tw-mr-1"></i>
                        <?php echo _l('assetcentral_go_back_to_project'); ?></a>
                </div>
