...
<div class="panel_s mtop25">
    <div class="panel-body">
        <ul class="nav nav-tabs no-margin " role="tablist">
            ...
            <?php if (get_option('hide_invoice_subcription_group_from_client_side') != 1) { ?>
            ...
            <div class="col-md-4 col-sm-6 mbot30 ">
                <div class="card panel-body">
                    <div class="card-body">
                        ...
                        <?php if (!isset($product->is_recurring)) { // is subscription product 
                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-6">
                                    ...
                                    <?= form_hidden('type', 'subscribe') ?>
                                    <?php
                                    if (!$showQuantity) {
                                        echo  form_hidden('quantity', '1');
                                    } else {
                                    ?>
                                        <input type="number" name="quantity" min="1" class="form-control" placeholder="<?= _l('quantity') ?>" required>
                                    <?php } ?>
                                </div>
                                <div class="col-md-6 col-xs-6">
