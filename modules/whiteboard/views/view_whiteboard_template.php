...
<link href="<?php echo base_url();?>modules/whiteboard/assets/css/template.css" rel="stylesheet">
...
<div class="modal-header task-single-header" data-task-single-id="<?php echo $whiteboard->id; ?>" >
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    <h4 class="modal-title"><?php echo $whiteboard->title; ?></h4>
</div>
<div class="modal-body">
    <div class="row">
        <div class="col-md-8 task-single-col-left">
            <div class="tc-content">
                <div id="whiteboard_draw">
        ...
        <div class="col-md-4 task-single-col-right">
            <h4 class="task-info-heading"><?php echo _l('whiteboard_info'); ?></h4>
            <div class="clearfix"></div>
            <h5 class="no-mtop task-info-created">
                <small class="text-dark"><?php echo _l('task_created_at','<span class="text-dark">'._dt($whiteboard->dateadded).'</span>'); ?></small>
            </h5>
            ...
            <div class="task-info task-info-billable">
                <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa fa-user-o"></i>
                    <?php echo _l('whiteboard_filter_staff'); ?>: <?php echo ($staff)?$staff->firstname.' '.$staff->lastname:'';?>
                </h5>
            </div>

            <div class="task-info task-info-billable">
                <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa fa-cog"></i>
                    <?php echo _l('whiteboard_filter_group'); ?>: <?php echo ($group)?$group->name:'';?>
                </h5>
            </div>
