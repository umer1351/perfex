...
<link href="<?php echo base_url();?>modules/whiteboard/assets/css/preview.css" rel="stylesheet">
<link rel="stylesheet" media="print" href="<?php echo base_url();?>modules/whiteboard/assets/css/print.css" />
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <span><a href="#" onclick="new_whiteboard();return false;" class="btn btn-success" style="float: right;margin-right:2px;">Properties</a></span>
                            <!-- <span><button id="print" type="button" class="btn btn-primary">Print</button>
                                <button id="expand-button" type="button" class="collapsible btn btn-success">Properties</button></span> -->
                        </h4>
                ...
                <div class="btn-bottom-toolbar text-right">
                    <a href="<?php echo admin_url('whiteboard'); ?>" class="btn btn-info whiteboard-btn"><?php echo _l('Go Back'); ?></a>
                </div>
            </div>
        </div>
        <div class="panel_s">
...
<?php init_tail(); ?>
<script src="<?php echo base_url();?>modules/whiteboard/assets/js/preview.js"></script>
