	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php echo new_html_entity_decode(_l('add_warranty_receipt_process')); ?></h4>
			</div>
			<?php echo form_open(admin_url('warranty_management/add_warranty_receipt_process_modal'), array('id' => 'add_warranty_receipt_process')); ?>
				...
				<div class="tab-content">
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="col-md-8">
								<?php echo render_input('name','wm_name','','text'); ?>   
							</div>
							<div class="col-md-12">
								<?php echo render_select('product_group_id',$product_groups, array('id', 'name'),'wm_product_group',''); ?>   
							</div>
