        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content chat-modal">
                <div class="chat-modal-header">
                    <h4><i class="fa fa-at"></i> <?= _l('chat_quick_mention_title'); ?></h4>
                    <button type="button" class="close-btn" data-dismiss="modal" aria-label="Close">
                        <i class="fa fa-times"></i>
                    </button>
                </div>
                <div class="chat-modal-body">
                    <p class="modal-subtitle">Link a CRM item to share in chat</p>
                    <?php
                    $rel_type = '';
                    $rel_id = '';
                    ...
                    <div class="form-group">
                        <label for="rel_type" class="control-label">
                            <i class="fa fa-folder-open text-muted"></i>
                            <?php echo _l('task_related_to'); ?>
                        </label>
                    ...
                    <div class="form-group<?php if ($rel_id == '') { echo ' hide'; } ?>" id="rel_id_wrapper">
                        <label for="rel_id" class="control-label">
                ...
                <div class="chat-modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-paper-plane"></i> <?= _l('chat_mention_text'); ?>
                    </button>
                </div>
            </div>
        </div>
