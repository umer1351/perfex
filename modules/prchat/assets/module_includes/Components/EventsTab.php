<?php if (is_admin()) { ?>
  <div class="actions" id="actions" data-toggle="tooltip" title="<?= _l('chat_actions_menu') ?>">
    <div class="dropdown">
      <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><svg class="i_settings" fill="#2663eb" viewBox="0 0 24 24">
      ...
      <ul class="dropdown-menu">
        <li class="i_broadcast"><a href="javascript:void(0)"><svg class="broadcast_svg_icon" viewBox="0 0 24 24">
