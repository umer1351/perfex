...
<div class="panel_s section-heading section-proposals">
  <div class="panel-body">
    <h4 class="no-margin section-text"><?php echo _l('job'); ?></h4>
  </div>
</div>
<div class="panel_s">
  <div class="panel-body">
    <table class="table dt-table table-proposals" data-order-col="3" data-order-type="desc">
      <thead>
        <tr>
          <th class="th-proposal-number"><?php echo _l('job') . ' #'; ?></th>
      ...
      <tbody>
        <?php foreach ($proposals as $proposal) { ?>
          <tr>
            <td>
              <a href="<?php echo site_url('job/' . $proposal['id'] . '/' . $proposal['hash']); ?>" class="td-proposal-url">
            ...
            <td>
              <a href="<?php echo site_url('job/' . $proposal['id'] . '/' . $proposal['hash']); ?>" class="td-proposal-url-subject">
