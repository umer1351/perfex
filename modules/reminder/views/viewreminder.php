...
$proposal->content = str_replace('{quote_items}',$items,$proposal->content);
?>
   ...
   <div class="top" data-sticky data-sticky-class="preview-sticky-header">
      <div class="container preview-sticky-container">
         <div class="row">
            <div class="col-md-12">
               <div class="pull-left">
                  <h4 class="bold no-mtop proposal-html-number"># <?php echo format_job_number($proposal->id); ?><br />
           ...
           <?php echo form_hidden('action','job_pdf'); ?>
           <?php echo form_close(); ?>
           <?php if(is_client_logged_in() && has_contact_permission('jobs')){ ?>
            ...
            <div class="tab-content">
               <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab') || $this->input->get('tab') === 'summary'){echo ' active';} ?>" id="summary">
                  ...
                  <p class="bold proposal-html-information">
                     <?php echo _l('job_information'); ?>
                  </p>
                  <address class="no-margin proposal-html-info">
                     <?php echo format_job_info($proposal, 'html'); ?>
                  </address>
