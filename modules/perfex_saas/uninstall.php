...
function perfex_saas_remove_installation($remove_data = false)
{
    ...
    if ($remove_data === true) {
        ...
        delete_option('perfex_saas_enable_auto_trial');
        delete_option('perfex_saas_notice_before_period');
        delete_option('perfex_saas_reserved_slugs');
        delete_option('perfex_saas_saas_db_pool');
        delete_option('perfex_saas_saas_mode');
