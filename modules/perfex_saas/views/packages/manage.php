        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tw-flex tw-justify-between">
                    <?php if (has_permission('perfex_saas_packages', '', 'create') && !empty($packages)) { ?>
                    <div class="tw-mb-2 sm:tw-mb-4">
                        <a href="<?php echo admin_url('perfex_saas/packages/create'); ?>" class="btn btn-primary">
                    ...
                    <?php if (has_permission('perfex_saas_packages', '', 'create') && !empty($packages)) { ?>
                    <div class="tw-mb-2 sm:tw-mb-4">
                        <a href="<?php echo admin_url('invoices') . '?' . PERFEX_SAAS_FILTER_TAG; ?>"
